...
// ============================================================
// SPINE SAVIOR — Adafruit Sensor Enclosure (2in x 1.5in boards)
// Board dimensions: 2in x 1.5in (50.8mm x 38.1mm)
// Interior includes ~2mm clearance on each side
// !! PRINT THIS FILE TWICE — you have two sensors of this size !!
// ============================================================
...
// Interior dimension X in mm (2in = 50.8mm + ~2mm clearance)
interior_x = 53;

// Interior dimension Y in mm (1.5in = 38.1mm + ~2mm clearance)
interior_y = 40;

// Interior dimension Z (HEIGHT) in mm
// !! MEASURE your tallest component and add 5mm, then update this value !!
interior_z = 20;
