...
// ============================================================
// SPINE SAVIOR — Central Hub Enclosure (Arduino + Multiplexer)
// Board dimensions: 3.5in x 2in (88.9mm x 50.8mm)
...
// Interior dimension X in mm (3.5in = 88.9mm + ~2mm clearance)
interior_x = 91;

// Interior dimension Y in mm (2in = 50.8mm + ~2mm clearance)
interior_y = 53;
