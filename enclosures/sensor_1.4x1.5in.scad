...
// ============================================================
// SPINE SAVIOR — Adafruit Sensor Enclosure (1.4in x 1.5in board)
// Board dimensions: 1.4in x 1.5in (35.6mm x 38.1mm)
...
// Interior dimension X in mm (1.4in = 35.6mm + ~2mm clearance)
interior_x = 38;
